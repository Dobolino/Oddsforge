...
def save_api_keys(
    ...
    *,
    ...
    """Write both API keys to a local env-style file. Returns the path used."""
...
def load_api_keys(*, path: Path | None = None) -> tuple[str, str] | None:
    """Load both keys from a local file. Returns None if missing or incomplete."""
