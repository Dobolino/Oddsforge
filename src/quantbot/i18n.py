...
_STRINGS: dict[str, dict[str, str]] = {
    ...
    "league.nations_league": {"de": "UEFA Nations League", "en": "UEFA Nations League"},
    "league.world_cup_qualifiers_europe": {
        "de": "WM-Quali Europa",
        "en": "WC Qualifiers Europe",
    },
    "league.euro_qualification": {"de": "EM-Qualifikation", "en": "Euro Qualification"},
    "league.premier_league": {"de": "Premier League", "en": "Premier League"},
    "league.bundesliga": {"de": "Bundesliga", "en": "Bundesliga"},
    "league.la_liga": {"de": "La Liga", "en": "La Liga"},
    "league.serie_a": {"de": "Serie A", "en": "Serie A"},
    "league.ligue_1": {"de": "Ligue 1", "en": "Ligue 1"},
    "league.champions_league": {"de": "Champions League", "en": "Champions League"},
    "league.nba": {"de": "NBA", "en": "NBA"},
